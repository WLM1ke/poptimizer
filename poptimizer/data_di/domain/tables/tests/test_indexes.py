...
from poptimizer.data_di.domain.tables import base, indexes
...
async def test_prepare_df_for_new_table(table, mocker):
    ...
    fake_gateway.get.assert_called_once_with("TICKER", None, "2020-12-15")
...
async def test_prepare_df_for_update_table(table, mocker):
    ...
    fake_gateway.get.assert_called_once_with("TICKER", "2020-12-14", "2020-12-15")
