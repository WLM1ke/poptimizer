...
ML_PARAMS = {
    "data": (
        ("Label", {"days": 264, "div_share": 0.4, "on_off": True}),
        ("Scaler", {"days": 243, "on_off": True}),
        ("Ticker", {"on_off": True}),
        ("Mom12m", {"days": 256, "on_off": True, "periods": 4}),
        ("DivYield", {"days": 268, "on_off": True, "periods": 1}),
        ("Mom1m", {"days": 27, "on_off": False}),
        ("RetMax", {"days": 35, "on_off": True}),
        ("ChMom6m", {"days": 91, "on_off": True}),
        ("STD", {"days": 24, "on_off": True}),
        ("DayOfYear", {"on_off": False}),
        ("TurnOver", {"days": 246, "normalize": False, "on_off": True}),
    ),
    "model": {
        "bagging_temperature": 1.400795642063944,
        "depth": 7,
        "l2_leaf_reg": 1.1481594991036508,
        "learning_rate": 0.0027564609579152277,
        "one_hot_max_size": 1000,
        "random_strength": 0.7780882281500701,
    },
}
