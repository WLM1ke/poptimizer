...
ML_PARAMS = {
    "data": (
        ("Label", {"days": 291, "div_share": 0.4, "on_off": True}),
        ("Scaler", {"days": 233, "on_off": True}),
        ("Ticker", {"on_off": True}),
        ("Mom12m", {"days": 268, "on_off": True, "periods": 3}),
        ...
        ("TurnOver", {"days": 221, "normalize": True, "on_off": True}),
        ("TurnOverVar", {"days": 239, "on_off": True}),
    ),
    "model": {
        "bagging_temperature": 0.4327424374145916,
        "depth": 4,
        "l2_leaf_reg": 1.58512123082764,
        "learning_rate": 0.003440070336306948,
        "one_hot_max_size": 1000,
        "random_strength": 0.6323198274945336,
    },
}
