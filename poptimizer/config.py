...
ML_PARAMS = {
    "data": (
        ("Label", {"days": 245, "div_share": 0.4, "on_off": True}),
        ("Scaler", {"days": 196, "on_off": True}),
        ("Ticker", {"on_off": True}),
        ("Mom12m", {"days": 237, "on_off": True, "periods": 3}),
        ("DivYield", {"days": 266, "on_off": True, "periods": 1}),
    ...
    "model": {
        "bagging_temperature": 0.6234191519070388,
        "depth": 7,
        "l2_leaf_reg": 1.657411974127208,
        "learning_rate": 0.00366090874731419,
        "one_hot_max_size": 1000,
        "random_strength": 0.593820583198191,
    },
}
