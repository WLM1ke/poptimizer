...
def edit_terminated() -> str:
    return formatting.Strikethrough("Terminated positions edit").as_markdown()
...
def edit_enter_quantity(edit: model.Edit, quantity: float) -> str:
    return formatting.as_list(
        formatting.as_key_value("Account", edit.account),
