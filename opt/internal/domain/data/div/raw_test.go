...
type testRepo struct {
	...
	entity data.Rows[Raw]
}

func (r testRepo) Get(_ context.Context, qid domain.QualifiedID) (domain.Aggregate[data.Rows[Raw]], error) {
	agg := domain.Aggregate[data.Rows[Raw]]{}
