...
удачно), поэтому может быть использован на свой страх и риск. В настоящее время разрабатываеся
[версия 4](https://github.com/WLM1ke/poptimizer/tree/v4), которая не совместима по данным, поэтому лучше
удалить базу данных и запустить все с нуля
