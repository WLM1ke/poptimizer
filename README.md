...
- если программа выдала предупреждение, что некоторые бумаги не были удалены (сообщения должны прийти в `Telegram`), желательно не спеша за несколько недель распродать их
