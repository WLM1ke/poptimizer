...
### Что за код в папках opt и evolve 

Пока находящаяся в разработке реализация оптимизации на Go с web-интерфейсом и эволюции на Python. Так как формат базы 
данных не совместим, то следует запускать на отдельной MongoDB.
