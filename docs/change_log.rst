...
0.7.0 (2020-01-05)
------------------
* Добавлен признак изменчивости ликвидности
* Объединен параметр оборачиваемости и объема торгов
* Осуществлен переход на Python 3.8
* Исправление - явное падение при попытке работы с акциями без регистрационного номера
