...
библиотеки `hyperopt <https://github.com/hyperopt/hyperopt>`_. так же существует возможность
оптимизации дивидендной доходности или любой взвешенной величины между общей и дивидендной доходностью.
